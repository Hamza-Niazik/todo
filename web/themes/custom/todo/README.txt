...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the todo folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/todo folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the todo.info.yml.txt file to
    ...
    For example, rename the foo/todo.info.yml.txt file to foo/foo.info.yml.
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename todo.libraries.yml to the name of your sub-theme, un-commenting
